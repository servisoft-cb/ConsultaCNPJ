...
procedure TF_Principal.btnCopiarDadosClick(Sender: TObject);
var
  NomeArquivo : String;
  arq : TextFile;
  i, n : integer;
begin
  NomeArquivo := ExtractFilePath(Application.ExeName) + 'ConsultaCNPJ.TXT';
  AssignFile(arq, NomeArquivo);
  Rewrite(arq);
  try
    Writeln(arq,EditCNPJ.Text);
    Writeln(arq,EditTipo.Text);
    Writeln(arq,EditRazaoSocial.Text);
    Writeln(arq,EditPorte.Text);
    Writeln(arq,EditAbertura.Text);
    Writeln(arq,EditFantasia.Text);
    Writeln(arq,EditEndereco.Text);
    Writeln(arq,EditNumero.Text);
    Writeln(arq,EditComplemento.Text);
    Writeln(arq,EditBairro.Text);
    Writeln(arq,EditCidade.Text);
    Writeln(arq,EditUF.Text);
    Writeln(arq,EditCEP.Text);
    Writeln(arq,EditSituacao.Text);
    Writeln(arq,EditCNAE1.Text);
    Writeln(arq,EditEmail.Text);
    Writeln(arq,EditTelefone.Text);
  finally
